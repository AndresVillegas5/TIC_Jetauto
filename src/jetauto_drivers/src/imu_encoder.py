...
def handleSerialData(raw_data):
    ...
    if key < 11:  
        ...
        if angle_flag:
            ...
            y = (y - offset_mag)
            imu_encoder_msg.angle = y			#Angulo en radianes
            #y = math.radians(y)
...
def init_imu():
    global readreg, flag, calibuff, wt_imu, iapflag, mag_offset, mag_range, version, recordflag, baudlist, offset_mag
    ...
    print(imu_encoder_msg.imu.orientation.x, imu_encoder_msg.imu.orientation.y, imu_encoder_msg.imu.orientation.z, imu_encoder_msg.imu.orientation.w)
    (r,p,offset_mag) = tf.transformations.euler_from_quaternion((imu_encoder_msg.imu.orientation.x,imu_encoder_msg.imu.orientation.y,imu_encoder_msg.imu.orientation.z,imu_encoder_msg.imu.orientation.w))
    #print(offset_mag)    
